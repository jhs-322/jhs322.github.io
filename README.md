...
> 조하선(Haseon Jo) - jhs-322 포트폴리오

<br />

# 👋 Intro

> 안녕하세요! ***"항상 새로운 것을 배우고 도전하고 싶은"*** 조하선입니다!  
...
> 과외 선생님을 위한 앱, 슈터디_(사용자인터페이스및실습-2조)_
>
> - 개발기간 : 2024.07.02-11.25
> - 핵심 역할 : 로그인 서비스와 db연동, 홈화면 드로어 상세 구현, 채팅 기능 구현
>   
> - language : java, xml
...
> 강의 : 내일배움캠프 - 정보보안 과정 3기
> 
> - 교재 : 파이썬과 40개의 작품들 (장문철 저)
> - 제작률 : 28/40
> - 개발기간 : 2025.02.19-03.07
> - 핵심 역할 : 파이썬을 활용한 업무 자동화, GUI 구현
>
> - language : python
> - skill : flask, streamlit, 
> - [프로젝트 상세 설명](https://github.com/jhs-322/python40)

<br />

## 3. 👞 파이썬과 40개의 작품들 디벨롭

> 맵 탈출 게임 _(내일배움캠프 - 4520조 팀프로젝트)_
>
> - 개발기간 : 2025.03.02-03.02
> - 핵심 역할 : map, player 클래스 구현, 루프 이벤트 처리
> - Language : python3
> - Skill : PyQt
>
> [프로젝트 상세 설명](https://github.com/jhs-322/develop_ver)

<br />

## 3. 🍻 귀로 보는 웹사이트

> 귀로 보는 웹사이트 _(내일배움캠프 - 판타스틱4조 팀프로젝트)_
> - 개요 : 시각 장애인들이 쓸 수 있는 웹사이트. 음성으로 메뉴 클릭을 자동화 해준다. 유튜브, 지메일, 검색이 가능하다.
> - 개발기간 : 2025.03.06 ~ 
